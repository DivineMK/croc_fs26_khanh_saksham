...
# Bank1: top-right, pins facing up
...
# Bank2: top-left2, pins facing down
set bank2X [expr $floor_leftX]
set bank2Y [expr $floor_topY - 2*$RamSize512x64_H - 40]
placeInstance $bank2_sram0 $bank2X $bank2Y R0

# Bank3: bottom-mid, pins facing up
set bank3X [expr $floor_rightX -$RamSize512x64_W]
set bank3Y [expr $floor_topY - 2*$RamSize512x64_H - 40]
placeInstance $bank3_sram0 $bank3X $bank3Y R0

# Bank4: bottom-mid, pins facing up
set bank4X [expr $floor_midpointX -$RamSize256x64_W/2]
set bank4Y [expr $floor_bottomY]
placeInstance $bank4_sram0 $bank4X $bank4Y MX
