...
place_pad -row IO_EAST  -location [expr {$eastStart +  7*$eastPitch}] "pad_green0_o"    ; # pin no:  8
place_pad -row IO_EAST  -location [expr {$eastStart +  8*$eastPitch}] "pad_green1_o"    ; # pin no:  9
place_pad -row IO_EAST  -location [expr {$eastStart +  9*$eastPitch}] "pad_green2_o"    ; # pin no: 10
place_pad -row IO_EAST  -location [expr {$eastStart + 10*$eastPitch}] "pad_green3_o"    ; # pin no: 11
place_pad -row IO_EAST  -location [expr {$eastStart + 11*$eastPitch}] "pad_green4_o"    ; # pin no: 12
place_pad -row IO_EAST  -location [expr {$eastStart + 12*$eastPitch}] "pad_green5_o"    ; # pin no: 13
...
place_pad -row IO_NORTH -location [expr {$northStart -  3*$northPitch}] "pad_hsync_o"       ; # pin no:  4
place_pad -row IO_NORTH -location [expr {$northStart -  4*$northPitch}] "pad_vsync_o"       ; # pin no:  5
place_pad -row IO_NORTH -location [expr {$northStart -  5*$northPitch}] "pad_blue0_o"       ; # pin no:  6
place_pad -row IO_NORTH -location [expr {$northStart -  6*$northPitch}] "pad_blue1_o"       ; # pin no:  7
place_pad -row IO_NORTH -location [expr {$northStart -  7*$northPitch}] "pad_blue2_o"       ; # pin no:  8
place_pad -row IO_NORTH -location [expr {$northStart -  8*$northPitch}] "pad_blue3_o"       ; # pin no:  9
place_pad -row IO_NORTH -location [expr {$northStart -  9*$northPitch}] "pad_blue4_o"       ; # pin no: 10
place_pad -row IO_NORTH -location [expr {$northStart - 10*$northPitch}] "pad_red0_o"       ; # pin no: 11
place_pad -row IO_NORTH -location [expr {$northStart - 11*$northPitch}] "pad_red1_o"       ; # pin no: 12
place_pad -row IO_NORTH -location [expr {$northStart - 12*$northPitch}] "pad_red2_o"       ; # pin no: 13
place_pad -row IO_NORTH -location [expr {$northStart - 13*$northPitch}] "pad_red3_o"       ; # pin no: 14
place_pad -row IO_NORTH -location [expr {$northStart - 14*$northPitch}] "pad_red4_o"       ; # pin no: 15
